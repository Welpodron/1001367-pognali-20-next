...
const _deepClone = (obj: Record<any, any>): any[] | Record<any, any> => {
  ...
  if (obj instanceof File || obj instanceof FileList || obj instanceof Blob) {
    return obj;
  }
...
/**
 * @deprecated (Лучше использовать сторонние библиотеки, особенно в связи с датами, файлами и тд)
 * Функция производит `глубокое` сравнение объектов
 * @param {obj1} obj1 - объект 1
 * @param {obj2} obj2 - объект 2
